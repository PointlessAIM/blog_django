...
SECRET_KEY = "django-insecure-l1s-&^tghao!jc$g9f0f!*0k7##5c51j4#)-shthg#j!pdb8wc"
...
STATICFILES_DIRS = [Path.joinpath(BASE_DIR, "static")] # this is the directory where static files will be collected from
